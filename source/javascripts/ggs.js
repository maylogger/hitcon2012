...
var guideColor = 'rgba(211, 59, 58, .1)';
var guideInnerColor = 'rgba(211, 59, 58, .4)';
var guideOpacity = '1';

var switchColor = 'rgba(255,255,255,.7)';
...
/*  Create CSS */
    var styles = '\
        ...
        .ggs-guide{position:absolute;top:0;z-index:1;height:100%;margin-left:-0.75em;border:solid '+guideColor+';border-width:0 0.75em;background:'+guideColor+';opacity:'+guideOpacity+'; -webkit-transition: all 0.235s ease-out; -moz-transition: all 0.235s ease-out; -ms-transition: all 0.235s ease-out; transition: all 0.235s ease-out;}\
